...
-- y[1]	=>  Location: PIN_Y12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[2]	=>  Location: PIN_AC12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[3]	=>  Location: PIN_AD11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[4]	=>  Location: PIN_AB12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[5]	=>  Location: PIN_AA12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[6]	=>  Location: PIN_AE13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[7]	=>  Location: PIN_AC11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[8]	=>  Location: PIN_AC10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[9]	=>  Location: PIN_AA13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[10]	=>  Location: PIN_AB13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[11]	=>  Location: PIN_AF14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[12]	=>  Location: PIN_AE14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[13]	=>  Location: PIN_AF13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[14]	=>  Location: PIN_AG11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- y[15]	=>  Location: PIN_AD12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- pragma translate_on
PORT MAP (
	datab => \fir_counter|auto_generated|counter_reg_bit\(1),
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datad => \fir_rom|srom|rom_block|auto_generated|q_a\(2),
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	asdata => \fir_shift_0[1]~_Duplicate_1_q\,
	clrn => \ALT_INV_clear~inputclkctrl_outclk\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	asdata => \fir_shift_0[4]~_Duplicate_1_q\,
	clrn => \ALT_INV_clear~inputclkctrl_outclk\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fir_adder_n10_reg|dffs[2]~20_combout\ = ((\fir_mult_xn_reg|dffs\(2) $ (\fir_mult_xn1_reg|dffs\(2) $ (!\fir_adder_n10_reg|dffs[1]~19\)))) # (GND)
-- \fir_adder_n10_reg|dffs[2]~21\ = CARRY((\fir_mult_xn_reg|dffs\(2) & ((\fir_mult_xn1_reg|dffs\(2)) # (!\fir_adder_n10_reg|dffs[1]~19\))) # (!\fir_mult_xn_reg|dffs\(2) & (\fir_mult_xn1_reg|dffs\(2) & !\fir_adder_n10_reg|dffs[1]~19\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_mult_xn_reg|dffs\(2),
	datab => \fir_mult_xn1_reg|dffs\(2),
	datad => VCC,
...
-- Equation(s):
-- \fir_adder_n10_reg|dffs[3]~22_combout\ = (\fir_mult_xn_reg|dffs\(3) & ((\fir_mult_xn1_reg|dffs\(3) & (\fir_adder_n10_reg|dffs[2]~21\ & VCC)) # (!\fir_mult_xn1_reg|dffs\(3) & (!\fir_adder_n10_reg|dffs[2]~21\)))) # (!\fir_mult_xn_reg|dffs\(3) & 
-- ((\fir_mult_xn1_reg|dffs\(3) & (!\fir_adder_n10_reg|dffs[2]~21\)) # (!\fir_mult_xn1_reg|dffs\(3) & ((\fir_adder_n10_reg|dffs[2]~21\) # (GND)))))
-- \fir_adder_n10_reg|dffs[3]~23\ = CARRY((\fir_mult_xn_reg|dffs\(3) & (!\fir_mult_xn1_reg|dffs\(3) & !\fir_adder_n10_reg|dffs[2]~21\)) # (!\fir_mult_xn_reg|dffs\(3) & ((!\fir_adder_n10_reg|dffs[2]~21\) # (!\fir_mult_xn1_reg|dffs\(3)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_mult_xn_reg|dffs\(3),
	datab => \fir_mult_xn1_reg|dffs\(3),
	datad => VCC,
...
-- Equation(s):
-- \fir_result_reg|dffs[4]~24_combout\ = ((\fir_adder_n10_reg|dffs\(4) $ (\fir_adder_n32_reg|dffs\(4) $ (!\fir_result_reg|dffs[3]~23\)))) # (GND)
-- \fir_result_reg|dffs[4]~25\ = CARRY((\fir_adder_n10_reg|dffs\(4) & ((\fir_adder_n32_reg|dffs\(4)) # (!\fir_result_reg|dffs[3]~23\))) # (!\fir_adder_n10_reg|dffs\(4) & (\fir_adder_n32_reg|dffs\(4) & !\fir_result_reg|dffs[3]~23\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_adder_n10_reg|dffs\(4),
	datab => \fir_adder_n32_reg|dffs\(4),
	datad => VCC,
...
-- Equation(s):
-- \fir_adder_n32_reg|dffs[5]~26_combout\ = (\fir_mult_xn2_reg|dffs\(5) & ((\fir_mult_xn3_reg|dffs\(5) & (\fir_adder_n32_reg|dffs[4]~25\ & VCC)) # (!\fir_mult_xn3_reg|dffs\(5) & (!\fir_adder_n32_reg|dffs[4]~25\)))) # (!\fir_mult_xn2_reg|dffs\(5) & 
-- ((\fir_mult_xn3_reg|dffs\(5) & (!\fir_adder_n32_reg|dffs[4]~25\)) # (!\fir_mult_xn3_reg|dffs\(5) & ((\fir_adder_n32_reg|dffs[4]~25\) # (GND)))))
-- \fir_adder_n32_reg|dffs[5]~27\ = CARRY((\fir_mult_xn2_reg|dffs\(5) & (!\fir_mult_xn3_reg|dffs\(5) & !\fir_adder_n32_reg|dffs[4]~25\)) # (!\fir_mult_xn2_reg|dffs\(5) & ((!\fir_adder_n32_reg|dffs[4]~25\) # (!\fir_mult_xn3_reg|dffs\(5)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_mult_xn2_reg|dffs\(5),
	datab => \fir_mult_xn3_reg|dffs\(5),
	datad => VCC,
...
-- Equation(s):
-- \fir_result_reg|dffs[8]~32_combout\ = ((\fir_adder_n10_reg|dffs\(8) $ (\fir_adder_n32_reg|dffs\(8) $ (!\fir_result_reg|dffs[7]~31\)))) # (GND)
-- \fir_result_reg|dffs[8]~33\ = CARRY((\fir_adder_n10_reg|dffs\(8) & ((\fir_adder_n32_reg|dffs\(8)) # (!\fir_result_reg|dffs[7]~31\))) # (!\fir_adder_n10_reg|dffs\(8) & (\fir_adder_n32_reg|dffs\(8) & !\fir_result_reg|dffs[7]~31\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_adder_n10_reg|dffs\(8),
	datab => \fir_adder_n32_reg|dffs\(8),
	datad => VCC,
...
-- Equation(s):
-- \fir_adder_n32_reg|dffs[9]~34_combout\ = (\fir_mult_xn2_reg|dffs\(9) & ((\fir_mult_xn3_reg|dffs\(9) & (\fir_adder_n32_reg|dffs[8]~33\ & VCC)) # (!\fir_mult_xn3_reg|dffs\(9) & (!\fir_adder_n32_reg|dffs[8]~33\)))) # (!\fir_mult_xn2_reg|dffs\(9) & 
-- ((\fir_mult_xn3_reg|dffs\(9) & (!\fir_adder_n32_reg|dffs[8]~33\)) # (!\fir_mult_xn3_reg|dffs\(9) & ((\fir_adder_n32_reg|dffs[8]~33\) # (GND)))))
-- \fir_adder_n32_reg|dffs[9]~35\ = CARRY((\fir_mult_xn2_reg|dffs\(9) & (!\fir_mult_xn3_reg|dffs\(9) & !\fir_adder_n32_reg|dffs[8]~33\)) # (!\fir_mult_xn2_reg|dffs\(9) & ((!\fir_adder_n32_reg|dffs[8]~33\) # (!\fir_mult_xn3_reg|dffs\(9)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_mult_xn2_reg|dffs\(9),
	datab => \fir_mult_xn3_reg|dffs\(9),
	datad => VCC,
...
-- Equation(s):
-- \fir_result_reg|dffs[9]~34_combout\ = (\fir_adder_n32_reg|dffs\(9) & ((\fir_adder_n10_reg|dffs\(9) & (\fir_result_reg|dffs[8]~33\ & VCC)) # (!\fir_adder_n10_reg|dffs\(9) & (!\fir_result_reg|dffs[8]~33\)))) # (!\fir_adder_n32_reg|dffs\(9) & 
-- ((\fir_adder_n10_reg|dffs\(9) & (!\fir_result_reg|dffs[8]~33\)) # (!\fir_adder_n10_reg|dffs\(9) & ((\fir_result_reg|dffs[8]~33\) # (GND)))))
-- \fir_result_reg|dffs[9]~35\ = CARRY((\fir_adder_n32_reg|dffs\(9) & (!\fir_adder_n10_reg|dffs\(9) & !\fir_result_reg|dffs[8]~33\)) # (!\fir_adder_n32_reg|dffs\(9) & ((!\fir_result_reg|dffs[8]~33\) # (!\fir_adder_n10_reg|dffs\(9)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_adder_n32_reg|dffs\(9),
	datab => \fir_adder_n10_reg|dffs\(9),
	datad => VCC,
...
-- Equation(s):
-- \fir_result_reg|dffs[12]~40_combout\ = ((\fir_adder_n32_reg|dffs\(12) $ (\fir_adder_n10_reg|dffs\(12) $ (!\fir_result_reg|dffs[11]~39\)))) # (GND)
-- \fir_result_reg|dffs[12]~41\ = CARRY((\fir_adder_n32_reg|dffs\(12) & ((\fir_adder_n10_reg|dffs\(12)) # (!\fir_result_reg|dffs[11]~39\))) # (!\fir_adder_n32_reg|dffs\(12) & (\fir_adder_n10_reg|dffs\(12) & !\fir_result_reg|dffs[11]~39\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_adder_n32_reg|dffs\(12),
	datab => \fir_adder_n10_reg|dffs\(12),
	datad => VCC,
...
-- Equation(s):
-- \fir_adder_n32_reg|dffs[14]~44_combout\ = ((\fir_mult_xn2_reg|dffs\(14) $ (\fir_mult_xn3_reg|dffs\(14) $ (!\fir_adder_n32_reg|dffs[13]~43\)))) # (GND)
-- \fir_adder_n32_reg|dffs[14]~45\ = CARRY((\fir_mult_xn2_reg|dffs\(14) & ((\fir_mult_xn3_reg|dffs\(14)) # (!\fir_adder_n32_reg|dffs[13]~43\))) # (!\fir_mult_xn2_reg|dffs\(14) & (\fir_mult_xn3_reg|dffs\(14) & !\fir_adder_n32_reg|dffs[13]~43\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fir_mult_xn2_reg|dffs\(14),
	datab => \fir_mult_xn3_reg|dffs\(14),
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datab => \fir_mult_xn1_reg|dffs\(15),
...
-- pragma translate_on
PORT MAP (
	datab => \fir_adder_n10_reg|dffs\(15),
