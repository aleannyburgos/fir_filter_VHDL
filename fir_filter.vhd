...
fir_adder_n32 : lpm_add_sub
	...
	port map( result=>fir_adder_n32_out, dataa=>fir_mult_xn3_out, datab=>fir_mult_xn2_out);
	
fir_adder_n10 : lpm_add_sub
	generic map(LPM_WIDTH=>16)
	port map( result=>fir_adder_n10_out, dataa=>fir_mult_xn1_out, datab=>fir_mult_xn0_out);
	
fir_adder : lpm_add_sub
	generic map(LPM_WIDTH=>16)
	port map(result=>fir_adder_out, dataa=>fir_adder_n32_out, datab=>fir_adder_n10_out);
